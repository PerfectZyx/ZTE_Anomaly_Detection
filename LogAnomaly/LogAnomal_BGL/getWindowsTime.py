...
def getRawTimeFromKeyList(windows_size,step_size,seq_file,prediction_list):
    time_list = []
...
def getRawTimeFromWindowsList(windows_size,step_size,seq_file,prediction_list):
    time_list = []
    with open(seq_file) as IN:
        for line in IN:
            l = line.strip().split()
