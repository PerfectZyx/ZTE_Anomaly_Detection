...
# * Filename      : train_vector_onehot.py
# * Description   :
'''
'''
# **********************************************************
...
def train_by_vector(para):
    ...
    if onehot ==1:
        y = np_utils.to_categorical(dataY, num_classes = n_templates)#转成one hot,维度为总的tags数量
        #y = np_utils.to_categorical(dataY, num_classes = n_templates, dtype='float64')#转成one hot,维度为总的tags数量
